  ...
  return (
    ...
    >
      <div className="min-h-screen flex flex-col">
        <header className="h-16 sm:mt-[-15px] sm:h-20 md:h-24 px-6 flex items-center border-b border-gray-200">
          <div className="w-20 sm:w-24 md:w-32 h-8 bg-gray-200 rounded-md" />
          <div className="ml-auto flex items-center gap-4">
            <div className="w-10 h-10 bg-gray-200 rounded-full sm:w-12 sm:h-12 md:w-14 md:h-14 sm:hidden" />
            <div className="w-20 h-6 bg-gray-200 rounded sm:w-24 sm:h-7 md:w-32 md:h-8 sm:mr-[-15px]" />
          </div>
        </header>
